                ...
                <div className="row">
                    <div className='col'>
                        <div style={{ paddingTop: '2rem' }} className="text-center">
                            ...
                            <h2 className='pb-25' style={{fontSize:'3em'}}>MEMBER CENTER</h2>
                        ...
                        <div>
                            ...
                            <h3 className='text-red text-center mb-0'><strong>NOTICE 2: </strong></h3>
                            ...
                            <h3 className='text-red text-center mb-0'><strong>NOTICE 3: </strong></h3>
