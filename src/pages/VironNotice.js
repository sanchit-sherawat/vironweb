                ...
                <div className="row">
                    <div className='col'>
                        ...
                        <div>
                            ...
                            <p className='text-center pb-15 mt-0'>The qualified, third-party MLM company that is integrated with VIRON systems is: &ldquo;<strong>SAVE CLUB</strong>&rdquo; (<strong>SC</strong>). <em>*Their information and details are located in the left column of this page, under &ldquo;Information &amp; Resources&rdquo;. </em><strong>NOTICE: Although SC has been integrated with VIRON systems, please note that VIRON and SC (a third-party company) are <u>separate entities</u>.</strong></p>
