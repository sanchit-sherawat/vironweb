                ...
                <div className="row">
                    <div className='col'>
                        ...
                        <div>
                            ...
                            <p className='text-center mt-0'>The qualified, third-party MLM company that is integrated with VIRON systems is: &ldquo;<strong>SAVE CLUB</strong>&rdquo; (<strong>SC</strong>). <em>*Their information and details are located on the left column of this page, under &ldquo;MLM COMPANY INFORMATION&rdquo;. </em><strong>NOTICE: Although SC has been integrated with VIRON systems, please note that VIRON and SC (a third-party company) are <u>separate entities</u>.</strong></p>
                            ...
                            <ul className=' mb-0'>
                                ...
                                <li><strong>VIRON Registration</strong> <strong>Fee</strong> <del>$39.95</del> (waived during pre-launch).</li>
                                <li><strong>VIRON Annual Membership Fee</strong> <del>$149.95</del> (waived during pre-launch).</li>
