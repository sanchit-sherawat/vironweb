...
export default function PaymentLandingPage() {
  return (
    ...
    <div className="landing-container">
        ...
        <p><strong className='text-red'>EMPHASIS:</strong> Please understand that we are currently in <strong><u>PRE-LAUNCH</u></strong>. The Pre-Launch will conclude when we reach 5,500 total members. We will then automatically enter <strong>FULL-LAUNCH</strong>.</p>
        ...
        <hr/>
        <p className='text-blue text-center mb-0'><strong>VIRON MEMBER SUPPORT:</strong></p>
