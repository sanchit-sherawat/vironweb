...
/n Please click OK to view an important NOTIFICATION.`);
            setFormData({
                user_id: '',
                btc_txn: '',
                eth_txn: '',
    ...
    return (
        <Layout>
            <div className="notice-container">
                ...
                <img src='https://viron.network/assets/img/viron-logo.svg' alt="Viron Logo" className="logo1" />
                </div>
                ...
                <div style={{ marginTop: '2rem' }}>
                    <p class=" "><strong>Please enter your crypto transaction ID:</strong></p>
                ...
                <p class=" "><em>-The VIRON Administration</em></p>
