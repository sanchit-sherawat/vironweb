...
function ForgotPasswordPage() {
    ...
    const handleSendCode = async (e) => {
        ...
        try {
            ...
            if (!response.ok) setError(data.message || 'Failed to send code');
            else setStep(2);
        } catch {
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            ...
            const data = await response.json();
            if (!response.ok) setError(data.message || 'Password reset failed');
                        ...
                        {step === 2 && (
                            <form onSubmit={handleResetPassword}>
                                ...
                                <div className="form-group" style={{ position: "relative" }}>
                                    ...
                                    />
                                    <span onClick={() => setShowPassword(p => !p)} style={{ position: "absolute", right: "20px", top: "50%", cursor: "pointer" }}>
                                ...
                                <div className="form-group" style={{ position: "relative" }}>
                                    ...
                                    />
                                    <span onClick={() => setShowConfirmPassword(p => !p)} style={{ position: "absolute", right: "20px", top: "50%", cursor: "pointer" }}>
