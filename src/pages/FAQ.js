...
function FAQ() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: (
        <>
          <p>All the information and details on the third-party MLM Company are in VIRON&rsquo;s Back-Office under: <strong><u>Third-Party MLM Company / Resource &amp; Information Center</u></strong>.</p>
        </>
      )
    },
    {
