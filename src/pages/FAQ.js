  ...
  const faqItems = [
    {
      ...
      answer: (
        <>
          <p class="pb-20"><strong>The VIRON Start-Up costs consist of:</strong></p>
          <ul>
          ...
          <p class="pb-20">*All VIRON Start-Up costs are subject to change based on market conditions and demand.* All fees are outlined at VIRON’s <strong><u>REGISTRATION</u></strong> page and also displayed in the VIRON back-office.</p>
        </>
      )
    },
    {
    ...
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20"><strong>Currently at this time - No. *However, we are open to corporate discussions and collaboration to significantly reduce the failure rate and drastically improve the success rate for all individuals in the industry, worldwide.</strong></p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">VIRON has logical and non-arbitrary parameters for qualifying any MLM &ldquo;<em>VEHICLE</em>&rdquo; for civic integration with VIRON systems. The said qualifying parameters and information for the MLM Company are located in the VIRON.NETWORK back-office. </p>
        </>
      )
    },
    {
    ...
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">Because the&nbsp;old&nbsp;ways do NOT WORK and produce a statistical 99% Failure Rate.</p>
          <ul>
          ...
          <p class="pb-20"><em>More details: </em></p>
          <ul>
            ...
            <li><abbr class="text-blue">*Automatically, as your DRs are fulfilled with excited and paying members, and as those members&rsquo; DRs are fulfilled, and so forth&hellip;your Downline grows Systematically with &ldquo;no holes&rdquo;.</abbr> VIRON is engineered to civically LEVEL THE PLAYING FIELD &ndash; FOR EVERYONE.</li>
    ...
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">All the information and details on the third-party MLM Company are in VIRON&rsquo;s Back-Office under: <strong><u>Third-Party MLM Company / Resource &amp; Information Center</u></strong>.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">VIRON&rsquo;s&nbsp;<a href="https://VIRON.NETWORK.com/faq"><strong><em>Dynamic Traffic Channels (&ldquo;DTC&rdquo;)</em></strong></a>&nbsp;does all the hard work to generate Leads, Contacts, and Traffic for you, automatically. Therefore, we do NOT need your Leads. <strong><u>Again, with VIRON, you no longer need to sell, sponsor, or recruit</u></strong>.</p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">Definitely not suggested, because <strong>Direct Referrals </strong>(<strong>DRs</strong>) are also known as the: &ldquo;FUEL &amp; ENGINE&rdquo; of your VIRON Home-Business. <abbr class="text-blue">Further, if you are not registered with VIRON.NETWORK, we will not know you exist, and cannot help you build your MLM downline. </abbr><em>In other words, you wouldn&rsquo;t want to buy a VEHICLE without the &ldquo;Engine and Fuel&rdquo;, would you?</em></p>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          <p class="pb-20">VIRON is headquartered in Malaysia with offices in the USA - Utah, and will expand accordingly. Our contact information is located on our <a href="https://www.VIRON.NETWORK/contactus">CONTACT US</a>&nbsp;page.</p>
          <p class="pb-20">We would be happy to hear from you and look forward to serving you. We also look forward to delivering success to you and would be proud to have your next proud Testimonial. </p>
        </>
      )
    }
  ];
        ...
        <div className="row">
          <div className='col'>
            ...
            <div className="text-center mb-10" style={{ padding: '0px 20px', border: '2px solid #000', width: '45%', margin: '0 auto' }}>
              <p class="pb-20"><strong>NOTE: General Questions are in font color: <em className="text-red">RED</em>.</strong><br /><strong>Answers or Comments are in font color: <em>BLACK</em> or <em className="text-blue">BLUE</em>.</strong></p>
            </div>

            <div className="pt-20 pb-1">
                <p class="pb-20"><strong className="text-blue">With VIRON.NETWORK (&ldquo;VIRON&rdquo;), you do not need to attend Meetings, Webinars, or read Emails, nor respond to any third-party MLM Company&rsquo;s "Newsletters". And definitely, no need for "training", etc., etc., etc. </strong><u>With VIRON&hellip;ALL of that is now irrelevant</u>! *This positive situation with VIRON is beneficial for the MLM Company itself, as VIRON handles all the hard work for you to build your MLM downline automatically. <u>Effectively eliminating all the traditional stresses</u>.</p>
                <hr />
            </div>
